...
//     // replace parsed img_names list here with just actual image names (b/c can't find)
//     // also check how simpler stitching algorithm finds the same files that this cannot
