...
#include "img_transform/msg/detail/keypoints__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const img_transform::msg::Keypoints *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<img_transform::msg::Keypoints *>(
    untyped_ros_message);
...
{
  return &img_transform::msg::typesupport_fastrtps_cpp::_Keypoints__handle;
}
