...
#include "img_transform/srv/detail/test__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const img_transform::srv::Test_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  img_transform::srv::Test_Request & ros_message)
{
  // Member: n
  cdr >> ros_message.n;
...
{
  auto typed_message =
    static_cast<const img_transform::srv::Test_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<img_transform::srv::Test_Request *>(
    untyped_ros_message);
...
{
  return &img_transform::srv::typesupport_fastrtps_cpp::_Test_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, img_transform, srv, Test_Request)() {
  return &img_transform::srv::typesupport_fastrtps_cpp::_Test_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_img_transform
cdr_serialize(
  const img_transform::srv::Test_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  img_transform::srv::Test_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const img_transform::srv::Test_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<img_transform::srv::Test_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &img_transform::srv::typesupport_fastrtps_cpp::_Test_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, img_transform, srv, Test_Response)() {
  return &img_transform::srv::typesupport_fastrtps_cpp::_Test_Response__handle;
}
...
{
  return &img_transform::srv::typesupport_fastrtps_cpp::_Test__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, img_transform, srv, Test)() {
  return &img_transform::srv::typesupport_fastrtps_cpp::_Test__handle;
}
