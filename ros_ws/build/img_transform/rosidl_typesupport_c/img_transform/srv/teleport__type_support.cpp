...
#include "img_transform/srv/detail/teleport__type_support.h"
...
static const _Teleport_Request_type_support_symbol_names_t _Teleport_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, img_transform, srv, Teleport_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, img_transform, srv, Teleport_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, img_transform, srv, Teleport_Request)() {
  return &::img_transform::srv::rosidl_typesupport_c::Teleport_Request_message_type_support_handle;
}
...
static const _Teleport_Response_type_support_symbol_names_t _Teleport_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, img_transform, srv, Teleport_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, img_transform, srv, Teleport_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, img_transform, srv, Teleport_Response)() {
  return &::img_transform::srv::rosidl_typesupport_c::Teleport_Response_message_type_support_handle;
}
...
static const _Teleport_type_support_symbol_names_t _Teleport_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, img_transform, srv, Teleport)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, img_transform, srv, Teleport)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, img_transform, srv, Teleport)() {
  return &::img_transform::srv::rosidl_typesupport_c::Teleport_service_type_support_handle;
}
