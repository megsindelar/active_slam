...
#include "img_transform/srv/detail/test__rosidl_typesupport_fastrtps_c.h"
...
using _Test_Request__ros_msg_type = img_transform__srv__Test_Request;
...
size_t get_serialized_size_img_transform__srv__Test_Request(
  const void * untyped_ros_message,
...
static uint32_t _Test_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_img_transform__srv__Test_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_img_transform
size_t max_serialized_size_img_transform__srv__Test_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Test_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_img_transform__srv__Test_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, img_transform, srv, Test_Request)() {
...
using _Test_Response__ros_msg_type = img_transform__srv__Test_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_img_transform
size_t get_serialized_size_img_transform__srv__Test_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Test_Response__ros_msg_type * ros_message = static_cast<const _Test_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_img_transform__srv__Test_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_img_transform
size_t max_serialized_size_img_transform__srv__Test_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Test_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_img_transform__srv__Test_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, img_transform, srv, Test_Response)() {
...
// already included above
// #include "img_transform/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "img_transform/srv/test.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, img_transform, srv, Test)() {
  return &Test__handle;
}
