...
#ifndef IMG_TRANSFORM__SRV__DETAIL__TELEPORT__FUNCTIONS_H_
#define IMG_TRANSFORM__SRV__DETAIL__TELEPORT__FUNCTIONS_H_
 ...
 * calls
 * img_transform__srv__Teleport_Request__init().
...
/**
 * It calls
 * img_transform__srv__Teleport_Request__fini()
 ...
 * img_transform__srv__Teleport_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * img_transform__srv__Teleport_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * img_transform__srv__Teleport_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_img_transform
...
/**
 * It calls
 * img_transform__srv__Teleport_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_img_transform
...
/**
 * It allocates the memory for the array and calls
 * img_transform__srv__Teleport_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_img_transform
...
/**
 * It calls
 * img_transform__srv__Teleport_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // IMG_TRANSFORM__SRV__DETAIL__TELEPORT__FUNCTIONS_H_
