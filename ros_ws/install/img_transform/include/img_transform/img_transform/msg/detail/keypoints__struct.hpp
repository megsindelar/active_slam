...
#ifndef IMG_TRANSFORM__MSG__DETAIL__KEYPOINTS__STRUCT_HPP_
#define IMG_TRANSFORM__MSG__DETAIL__KEYPOINTS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__img_transform__msg__Keypoints __attribute__((deprecated))
#else
# define DEPRECATED__img_transform__msg__Keypoints __declspec(deprecated)
#endif
...
struct Keypoints_
{
  ...
  // pointer types
  using RawPtr =
    img_transform::msg::Keypoints_<ContainerAllocator> *;
  using ConstRawPtr =
    const img_transform::msg::Keypoints_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<img_transform::msg::Keypoints_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<img_transform::msg::Keypoints_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      img_transform::msg::Keypoints_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<img_transform::msg::Keypoints_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<img_transform::msg::Keypoints_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<img_transform::msg::Keypoints_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<img_transform::msg::Keypoints_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__img_transform__msg__Keypoints
    std::shared_ptr<img_transform::msg::Keypoints_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__img_transform__msg__Keypoints
    std::shared_ptr<img_transform::msg::Keypoints_<ContainerAllocator> const>
...
using Keypoints =
  img_transform::msg::Keypoints_<std::allocator<void>>;
...
#endif  // IMG_TRANSFORM__MSG__DETAIL__KEYPOINTS__STRUCT_HPP_
