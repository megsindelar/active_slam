...
#ifndef IMG_TRANSFORM__MSG__DETAIL__KEYPOINTS__TRAITS_HPP_
#define IMG_TRANSFORM__MSG__DETAIL__KEYPOINTS__TRAITS_HPP_
...
[[deprecated("use img_transform::msg::to_block_style_yaml() instead")]]
inline void to_yaml(
  const img_transform::msg::Keypoints & msg,
  std::ostream & out, size_t indentation = 0)
{
  img_transform::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use img_transform::msg::to_yaml() instead")]]
inline std::string to_yaml(const img_transform::msg::Keypoints & msg)
{
  return img_transform::msg::to_yaml(msg);
}

template<>
inline const char * data_type<img_transform::msg::Keypoints>()
{
  return "img_transform::msg::Keypoints";
}

template<>
inline const char * name<img_transform::msg::Keypoints>()
{
  return "img_transform/msg/Keypoints";
}

template<>
struct has_fixed_size<img_transform::msg::Keypoints>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<img_transform::msg::Keypoints>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<img_transform::msg::Keypoints>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // IMG_TRANSFORM__MSG__DETAIL__KEYPOINTS__TRAITS_HPP_
