...
bool
img_transform__msg__Keypoints__init(img_transform__msg__Keypoints * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!rosidl_runtime_c__double__Sequence__init(&msg->x_1, 0)) {
    img_transform__msg__Keypoints__fini(msg);
    return false;
  }
  // y_1
...
void
img_transform__msg__Keypoints__fini(img_transform__msg__Keypoints * msg)
{
  if (!msg) {
    return;
  }
...
bool
img_transform__msg__Keypoints__are_equal(const img_transform__msg__Keypoints * lhs, const img_transform__msg__Keypoints * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
img_transform__msg__Keypoints__copy(
  const img_transform__msg__Keypoints * input,
  img_transform__msg__Keypoints * output)
{
  if (!input || !output) {
    return false;
  }
...
img_transform__msg__Keypoints__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  img_transform__msg__Keypoints * msg = (img_transform__msg__Keypoints *)allocator.allocate(sizeof(img_transform__msg__Keypoints), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(img_transform__msg__Keypoints));
  bool success = img_transform__msg__Keypoints__init(msg);
  if (!success) {
...
void
img_transform__msg__Keypoints__destroy(img_transform__msg__Keypoints * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    img_transform__msg__Keypoints__fini(msg);
...
bool
img_transform__msg__Keypoints__Sequence__init(img_transform__msg__Keypoints__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  img_transform__msg__Keypoints * data = NULL;

  if (size) {
    data = (img_transform__msg__Keypoints *)allocator.zero_allocate(size, sizeof(img_transform__msg__Keypoints), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = img_transform__msg__Keypoints__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        img_transform__msg__Keypoints__fini(&data[i - 1]);
      }
...
void
img_transform__msg__Keypoints__Sequence__fini(img_transform__msg__Keypoints__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      img_transform__msg__Keypoints__fini(&array->data[i]);
    }
...
img_transform__msg__Keypoints__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  img_transform__msg__Keypoints__Sequence * array = (img_transform__msg__Keypoints__Sequence *)allocator.allocate(sizeof(img_transform__msg__Keypoints__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = img_transform__msg__Keypoints__Sequence__init(array, size);
  if (!success) {
...
void
img_transform__msg__Keypoints__Sequence__destroy(img_transform__msg__Keypoints__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    img_transform__msg__Keypoints__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
img_transform__msg__Keypoints__Sequence__are_equal(const img_transform__msg__Keypoints__Sequence * lhs, const img_transform__msg__Keypoints__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!img_transform__msg__Keypoints__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
img_transform__msg__Keypoints__Sequence__copy(
  const img_transform__msg__Keypoints__Sequence * input,
  img_transform__msg__Keypoints__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(img_transform__msg__Keypoints);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    img_transform__msg__Keypoints * data =
      (img_transform__msg__Keypoints *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!img_transform__msg__Keypoints__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          img_transform__msg__Keypoints__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!img_transform__msg__Keypoints__copy(
