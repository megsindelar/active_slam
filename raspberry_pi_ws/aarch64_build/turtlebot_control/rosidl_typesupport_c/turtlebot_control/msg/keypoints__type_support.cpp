...
static const _Keypoints_type_support_symbol_names_t _Keypoints_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot_control, msg, Keypoints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlebot_control, msg, Keypoints)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlebot_control, msg, Keypoints)() {
  return &::turtlebot_control::msg::rosidl_typesupport_c::Keypoints_message_type_support_handle;
}
