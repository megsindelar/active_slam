...
static const _Keypoints_type_support_symbol_names_t _Keypoints_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot_control, msg, Keypoints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot_control, msg, Keypoints)),
  }
};
...
{
  return &::turtlebot_control::msg::rosidl_typesupport_cpp::Keypoints_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlebot_control, msg, Keypoints)() {
  return get_message_type_support_handle<turtlebot_control::msg::Keypoints>();
}
