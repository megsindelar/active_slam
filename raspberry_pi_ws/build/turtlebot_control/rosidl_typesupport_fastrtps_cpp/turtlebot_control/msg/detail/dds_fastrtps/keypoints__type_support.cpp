  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: keypoints_1
  {
    cdr << ros_message.keypoints_1;
  }
  // Member: keypoints_2
  {
    cdr << ros_message.keypoints_2;
  }
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  // Member: keypoints_1
  {
    ...
    size_t item_size = sizeof(ros_message.keypoints_1[0]);
  ...
  // Member: keypoints_2
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.keypoints_2[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
